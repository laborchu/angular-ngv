...
import {
  ...
  NgvPanelOption, NgvDataSource, NgvDsModel } from '../../../../../src/index';
...
export class FormComponent implements OnInit {
  ...
  option: NgvFormOption = {
    components: [
      ...
      { label: '爱好', property: "like", comp: NgvFormCheckbox, dataSource: new LikeDataSource(),value:[1],validations:[
          {msg:"爱好必选",type:"required",fn:Validators.required}

      ]},
      { label: '地区', property: "location", comp: NgvFormSelect, dataSource: new SelectDataSource(),value:1,validations:[
      ...
      { label: '出生日期', property: "date", comp: NgvFormDatePicker,validations:[
          ...
          {msg:"日期格式不正确",type:"date",fn:CustomValidators.date},
      ]},
