...
export class SeedConfig {
  ...
  */
  ...
  PACKAGE_JSON_PATH = join(process.cwd(),'package.json');
      ...
      'browser-sync': {
        ...
        server: {
          ...
          routes: {
            ...
            [`${this.APP_BASE}src`]: this.DIST_DIR+"/src",
            [`${this.APP_BASE}node_modules`]: 'node_modules',
            [`${this.APP_BASE}font/roboto/`]: 'node_modules/angular-bootstrap-md/font/roboto/',
